...
let arr = [
    { id: 1, name: "param", age: "19", profession: "developer" },
    { id: 2, name: "charam", age: "20", profession: "developer" },
    { id: 3, name: "karam", age: "19", profession: "admin" },
  ];
  ...
  function addData() {
    ...
    let newEmployee = { id: 4, name: "Prajwal Tetoo", age: "24", profession: "Frontend Developer" };
  ...
  function concatenateArray() {
    ...
    let anotherArray = [
      { id: 5, name: "ramesh khade", age: "21", profession: "tester" },
      { id: 6, name: "smitesh", age: "22", profession: "designer" },
      { id: 7, name: "ranveer", age: "23", profession: "manager" },
    ];
